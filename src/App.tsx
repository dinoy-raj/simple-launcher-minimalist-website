...
function App() {
  return (
    <div className="min-h-screen text-white flex flex-col relative">
      <ParticleBackground />
      {/* Header */}
      <header className="flex justify-between items-center p-6 animate-fade-in-up">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 text-center">
        ...
        <img
          ...
          className="w-24 h-24 mb-12 shadow-lg rounded-3xl bg-white p-2 animate-fade-in-up delay-100"
        />

        {/* Main Heading */}
        <h2 className="text-4xl md:text-6xl font-bold mb-4 leading-tight max-w-4xl animate-fade-in-up delay-200">
          Best
          <TextRotator />
          <br />
        ...
        {/* Description */}
        <p className="text-gray-400 text-lg md:text-xl max-w-2xl mb-12 leading-relaxed animate-fade-in-up delay-300">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center bg-transparent border-2 border-gray-600 hover:border-white rounded-2xl px-6 py-3 transition-all duration-300 hover:bg-white hover:text-black group animate-fade-in-up delay-500"
        >
      ...
      {/* Footer */}
      <footer className="p-6 text-center text-gray-500 text-sm animate-fade-in-up delay-700">
        Built with ❤️ by{" "}
        <a
