    ...
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 text-center">
        ...
        <p className="text-gray-400 text-lg md:text-xl max-w-2xl mb-12 leading-relaxed">
          Distraction-free, clutter-free interface designed to help you reduce screen time and boost focus. Complete customization without compromising simplicity.
        </p>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center bg-transparent border-2 border-gray-600 hover:border-white rounded-2xl px-6 py-3 transition-all duration-300 hover:bg-white hover:text-black group"
        >
