    ...
    <div className="min-h-screen text-white flex flex-col relative">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 text-center">
        ...
        <img
          ...
          className="w-24 h-24 mb-12 shadow-lg rounded-3xl bg-white p-2 animate-fade-in-up animate-delay-100 transition-all duration-300 hover:rounded-xl"
        />
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center bg-transparent border-2 border-gray-600 hover:border-white rounded-2xl px-6 py-3 transition-all duration-300 hover:bg-white hover:text-black group animate-fade-in-up animate-delay-400 hover:rounded-xl"
        >
